    ...
    <div class="page-body">
      <div class="container-xl">
        <div class="row row-cards">
          <div class="col-lg-4">
            <form class="card" method="POST" action="{{route('mitras.update',$mitra->id)}}">
              @csrf
              @method('PUT')
              ...
              <div class="card-body">
                <div class="row row-cards">
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="nama_mitra" class="form-control" value="{{ $mitra->nama_mitra }}">
                    @error('nama_mitra')
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="no_hp" class="form-control" value="{{ $mitra->no_hp }}">
                    @error('no_hp')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                  </div>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <select name="kelamin" class="form-select">
                      <option value="laki-laki" {{ $mitra->kelamin == 'laki-laki' ? 'selected' : '' }}>laki-laki</option>
                      <option value="perempuan" {{ $mitra->kelamin == 'perempuan' ? 'selected' : '' }}>perempuan</option>
                    </select>
                    @error('kelamin')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <select name="status" class="form-select">
                      ...
                      <option value="non_active" {{ $mitra->status == 'non_active' ? 'selected' : '' }}>non_active</option>
                    </select>
                    @error('status')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                  ...
                  <div class="mb-3">
                      ...
                      <input type="text" name="catatan" class="form-control" value="{{ $mitra->catatan }}">
                      @error('catatan')
                          <span class="text-danger">{{ $message }}</span>
                      @enderror
                  </div>
