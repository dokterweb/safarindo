                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="nik" class="form-control" value="{{ $jamaah->nik }}" maxlength="16" pattern="\d{16}" inputmode="numeric">
                            @error('nik')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="tempat_lahir" class="form-control" value="{{ $jamaah->tempat_lahir }}">
                            @error('tempat_lahir')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="kota" class="form-control" value="{{ $jamaah->kota }}">
                            @error('kota')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" name="no_hp" class="form-control" value="{{ $jamaah->no_hp  }}">
                            @error('no_hp')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="nama_jamaah_pasport" class="form-control" value="{{$jamaah->nama_jamaah_pasport }}">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="no_pasport" class="form-control" value="{{$jamaah->no_pasport }}">
                            @error('no_pasport')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="penerbit" class="form-control" value="{{$jamaah->penerbit }}">
                            @error('penerbit')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                       <div class="col-md-4 mb-3">
                            ...
                            <input type="date" name="pasport_aktif" class="form-control" value="{{$jamaah->pasport_aktif }}">
                            @error('pasport_aktif')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" name="pasport_expired" class="form-control" value="{{$jamaah->pasport_expired }}">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                @if($jamaah->foto_jamaah)
                                    <img src="{{ asset('storage/'.$jamaah->foto_jamaah) }}" width="150">
                                @endif
                            ...
                            <div class="col-md-4 mb-3">
                                @if($jamaah->foto_ktp)
                                    <img src="{{ asset('storage/'.$jamaah->foto_ktp) }}" width="150">
                                @endif
                            ...
                            <div class="col-md-4 mb-3">
                                @if($jamaah->foto_kk)
                                    <img src="{{ asset('storage/'.$jamaah->foto_kk) }}" width="150">
                                @endif
                            ...
                            <div class="col-md-4 mb-3">
                                @if($jamaah->foto_pasport1)
                                    <img src="{{ asset('storage/'.$jamaah->foto_pasport1) }}" width="150">
                                @endif
                            ...
                            <div class="col-md-4 mb-3">
                                @if($jamaah->foto_pasport2)
                                    <img src="{{ asset('storage/'.$jamaah->foto_pasport2) }}" width="150">
                                @endif
