      ...
      <div class="container-xl">
        <div class="row row-cards">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="card-footer text-end">
                                <a href="{{ route('pembayarans.detail', $jamaah->id) }}" class="btn btn-primary">
            ...
            <div class="col-7">
                <div class="card">
                    <div class="card-body">
                    <form action="{{ route('jamaah.paket.produk.store') }}" method="POST">
                        @csrf
                        ...
                        <table class="table table-vcenter card-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $p->stok }}</td>
                                    <td>
                                        <input type="number" name="qty[{{ $p->id }}]" class="form-control" value="1">
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
