                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <div class="row align-items-center">
                                    ...
                                    @endif
                                  <div class="col-auto">
                                    <a href="{{ route('pembayarans.print', $jamaah->id) }}" 
                    ...
                    <div class="col-md-12">
                        <form class="card" action="{{ route('pembayarans.store', $jamaah) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-header bg-blue-lt">
                                <h3 class="card-title">{{ $isTabungan ? 'Input Tabungan' : 'Input Pembayaran Paket' }}</h3>
                            </div>
                            <div class="card-body">
                                <div class="mb-3">
    ...
    <div class="modal-dialog modal-lg">
        <form method="POST" action="{{ route('jamaah.ambilPaket', $jamaah->id) }}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Pilih Paket Baru</h5>
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <input type="radio" name="paket_id" value="{{ $paket->id }}" required>
                                </td>
                                <td>{{ $paket->nama_paket }}</td>
                                <td>{{ $paket->tgl_berangkat }}</td>
