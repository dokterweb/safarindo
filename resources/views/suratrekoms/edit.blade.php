    ...
    <div class="page-body">
      <div class="container-xl">
        <div class="row justify-content-center">
          <div class="col-8">
            <div class="card">
            <form action="{{ route('suratrekoms.update', $surat->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="kantor_imigrasi" class="form-control" value="{{ $surat->kantor_imigrasi }}">
                        </div>
                    
                        <div class="col-md-4 mb-3">
                            <label>Nama Ayah</label>
                            <input type="text" name="nama_ayah" class="form-control" value="{{ $surat->nama_ayah }}">
                        </div>
                    
                        <div class="col-md-4 mb-3">
                            <label>Nama Kakek</label>
                            <input type="text" name="nama_kakek" class="form-control" value="{{ $surat->nama_kakek }}">
                        </div>
                       <div class="col-md-6 mb-3">
                            <label>Catatan</label>
