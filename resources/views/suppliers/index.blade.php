    ...
    <div class="page-body">
      <div class="container-xl">
        <div class="row row-cards">
          <div class="col-lg-4">
            <form class="card" method="POST" action="{{route('suppliers.store')}}">
              @csrf
                    ...
                    @forelse ($suppliers as $m)
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                  ...
                                  <form method="POST" action="{{ route('suppliers.destroy', $m->id) }}" id="delete-form-{{ $m->id }}"> 
                                      @csrf
                                      @method('DELETE')
