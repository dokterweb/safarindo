          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                ...
                <a class="dropdown-item {{request()->routeIs('kamars')?'active':''}}" href="{{route('kamars')}}">
                  Tipe Kamar
                </a>
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('pakets.jamaah') }}" >
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                  <i class="nav-icon fas fa-cog"></i>
                </span>
                <span class="nav-link-title">Input Jamaah</span>
              </a>
            </li>
            <li class="nav-item">
