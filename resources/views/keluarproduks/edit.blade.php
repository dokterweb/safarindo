    ...
    <div class="page-body">
      <div class="container-xl">
        <div class="row justify-content-center">
          <div class="col-10">
            <div class="card">
            <form action="{{ route('keluarproduks.update', $keluar->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="jamaah_id" value="{{ $keluar->jamaah_id }}">
                            <input type="text" name="paket_id" value="{{ $keluar->paket_id }}">
                            <input type="text" class="form-control" value="{{ $keluar->jamaah->nama_jamaah }}" disabled>
                        </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-4 mb-3">
                            <label>Tax (%)</label>
                            <input type="number" id="tax" name="tax" class="form-control" value="{{ $keluar->tax }}">
                        </div>
                    
                        <div class="col-md-4 mb-3">
                            <label>Diskon</label>
                            <input type="number" id="diskon_global" name="diskon" class="form-control" value="{{ $keluar->diskon }}">
                        </div>
                    
                        <div class="col-md-4 mb-3">
                            <label>Shipping</label>
                            <input type="number" id="shipping" name="shipping" class="form-control" value="{{ $keluar->shipping }}">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label>Status</label>
                            <select name="statuskeluar" class="form-select">
                                <option value="process" {{ $keluar->statuskeluar == 'process' ? 'selected' : '' }}>process</option>
                                <option value="delivery" {{ $keluar->statuskeluar == 'delivery' ? 'selected' : '' }}>delivery</option>
                                <option value="completed" {{ $keluar->statuskeluar == 'completed' ? 'selected' : '' }}>completed</option>
                            </select>
                            @error('statuskeluar')
                        ...
                        <div class="col-md-4 mb-3">
                            <label>Metode</label>
                            <select name="metodekirim" class="form-select">
                                <option value="kurir" {{ $keluar->metodekirim == 'kurir' ? 'selected' : '' }}>kurir</option>
                                <option value="kantor" {{ $keluar->metodekirim == 'kantor' ? 'selected' : '' }}>kantor</option>
                                <option value="delivery" {{ $keluar->metodekirim == 'delivery' ? 'selected' : '' }}>delivery</option>
                                <option value="other" {{ $keluar->metodekirim == 'other' ? 'selected' : '' }}>other</option>
                            </select>
                            @error('statuskeluar')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-12 mb-3">
                            <label>Alamat</label>
                            <input type="text" id="alamat" name="alamat" class="form-control" value="{{ $keluar->alamat }}">
                        </div>
                        <div class="col-md-12 mb-3">
                            <label>Catatan</label>
                            <input type="text" id="catatan" name="catatan" class="form-control" value="{{ $keluar->catatan }}">
                        </div>
                    </div>
