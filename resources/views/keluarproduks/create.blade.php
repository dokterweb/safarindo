    ...
    <div class="page-body">
      <div class="container-xl">
        <div class="row justify-content-center">
          <div class="col-10">
            <div class="card">
            <form action="{{ route('keluarproduks.store') }}" method="POST">
                @csrf
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ $jamaah->nama_jamaah }}" disabled>
                        </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-4 mb-3">
                            <label>Diskon</label>
                            <input type="number" id="diskon_global" name="diskon" class="form-control">
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="statuskeluar" class="form-select">
                                <option value="process" {{ old('statuskeluar') == 'process' ? 'selected' : '' }}>process</option>
                                <option value="delivery" {{ old('statuskeluar') == 'delivery' ? 'selected' : '' }}>delivery</option>
                                <option value="completed" {{ old('statuskeluar') == 'completed' ? 'selected' : '' }}>completed</option>
                            </select>
                            @error('statuskeluar')
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="metodekirim" class="form-select">
                                <option value="kurir" {{ old('statuskeluar') == 'kurir' ? 'selected' : '' }}>kurir</option>
                                <option value="kantor" {{ old('statuskeluar') == 'kantor' ? 'selected' : '' }}>kantor</option>
                                <option value="delivery" {{ old('statuskeluar') == 'delivery' ? 'selected' : '' }}>delivery</option>
                                <option value="other" {{ old('statuskeluar') == 'other' ? 'selected' : '' }}>other</option>
                            </select>
                            @error('statuskeluar')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
