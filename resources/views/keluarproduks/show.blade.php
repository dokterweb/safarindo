                    ...
                    <div class="row">
                        <div class="col-6">
                          ...
                          <div class="col-6 text-end">
                            <p class="h3">Jamaah</p>
                            <address>
                                {{ $keluarproduk->jamaah->nama_jamaah }}<br>
                                {{ $keluarproduk->jamaah->no_hp }}<br>
                                {{ $keluarproduk->jamaah->alamat }}<br>
                                {{ $keluarproduk->jamaah->kota }}<br>
                            </address>
                          </div>
                          <div class="col-12 my-5">
                            <h1>Invoice #PB-{{ str_pad($keluarproduk->id, 5, '0', STR_PAD_LEFT) }}</h1>
                          </div>
                        </div>
                        <table class="table table-transparent table-responsive">
                            ...
                            @foreach ($keluarproduk->details as $i => $d)
                            <tr>
                                <td>{{ $i+1 }}</td>
                                <td>
