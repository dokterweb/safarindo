    ...
    <div class="page-body">
      <div class="container-xl">
        <div class="row justify-content-center">
          <div class="col-8">
            <div class="card">
            <form action="{{ route('suratcutis.update', $surat->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="card-header bg-cyan">
                    <h3 class="card-title">Edit Surat Rekomendasi</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label>Nama Jamaah</label>
                            <input type="text" id="search_jamaah" class="form-control"
                            value="{{ $surat->jamaah->nama_jamaah }}">
                    
                            <input type="hidden" name="jamaah_id" id="jamaah_id"
                            value="{{ $surat->jamaah_id }}">
                            <div id="result_jamaah" class="list-group"></div>
                        </div>
                    
                        <div class="col-md-6 mb-3">
                            <label>Nama Paket</label>
                            <input type="text" id="paket_nama" class="form-control"
                            value="{{ $surat->paket->nama_paket }}" readonly>
                    
                            <input type="hidden" name="paket_id" id="paket_id"
                            value="{{ $surat->paket_id }}">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="nama_kantor" class="form-control" value="{{ $surat->nama_kantor }}">
                        </div>
                    
                        <div class="col-md-6 mb-3">
                            <label>Alamat Kantor</label>
                            <input type="text" name="alamat_kantor" class="form-control" value="{{ $surat->alamat_kantor }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label>Jabatan</label>
                            <input type="text" name="jabatan" class="form-control" value="{{ $surat->jabatan }}">
                        </div>
                    
                       <div class="col-md-6 mb-3">
                            <label>Catatan</label>
                            <input type="text" id="catatan" name="catatan" class="form-control" value="{{ $surat->catatan }}">
                        </div>
                    </div>
...
<script>
    ...
    $('#search_jamaah').on('keyup', function(e){
        ...
        $.get('/suratcutis/search-jamaah?q='+keyword, function(data){
