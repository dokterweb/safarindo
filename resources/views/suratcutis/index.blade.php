        ...
        <div class="container-xl">
          <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
              <div class="btn-list">
                <a href="{{route('suratcutis.create')}}" class="btn btn-primary d-none d-sm-inline-block">Create New</a>
              </div>
            </div>
          </div>
        </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="btn-list flex-nowrap">
                              <a href="{{route('suratcutis.edit',$p->id)}}" class="btn btn-sm btn-info">Edit</a>
                              <a href="{{ route('suratcutis.print', $p->id) }}" class="btn btn-sm btn-success"target="_blank">
