    ...
    <div class="page-body">
      <div class="container-xl">
        <div class="row row-cards">
          <div class="col-lg-12">
            <div class="card">
            <form action="{{ route('pakets.store') }}" method="POST" enctype="multipart/form-data"  class="card">
                @csrf
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="date" name="tgl_berangkat" class="form-control" value="{{ old('tgl_berangkat') }}">
                            @error('tgl_berangkat')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="jlh_hari" class="form-control" value="{{ old('jlh_hari') }}">
                            @error('jlh_hari')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="rute" class="form-select">
                                <option value="direct" {{ old('rute') == 'direct' ? 'selected' : '' }}>direct</option>
                                <option value="transit" {{ old('rute') == 'transit' ? 'selected' : '' }}>transit</option>
                            </select>
                            @error('rute')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="lokasi_berangkat" class="form-control" value="{{ old('lokasi_berangkat') }}">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="jenis_paket" class="form-control" value="{{ old('jenis_paket') }}">
                            @error('jenis_paket')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="hotel_makah_id" id="hotel_makah_id" class="form-select" required>
                                ...
                                @foreach ($hotelmakahs as $makah)
                                    <option value="{{ $makah->id }}" {{ old('hotel_makah_id') == $makah->id ? 'selected' : '' }}>{{ $makah->nama_hotel }}</option>
                                @endforeach
                            </select>   
                        </div>
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="hotel_madinah_id" id="hotel_madinah_id" class="form-select" required>
                                ...
                                @foreach ($hotelmadinahs as $madinah)
                                    <option value="{{ $madinah->id }}" {{ old('hotel_madinah_id') == $madinah->id ? 'selected' : '' }}>{{ $madinah->nama_hotel }}</option>
                                @endforeach
                            </select>   
                        </div>
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="hotel_transit_id" id="hotel_transit_id" class="form-select" required>
                                ...
                                @foreach ($hoteltransits as $transit)
                                    <option value="{{ $transit->id }}" {{ old('hotel_transit_id') == $transit->id ? 'selected' : '' }}>{{ $transit->nama_hotel }}</option>
                                @endforeach
                            </select>   
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Harga Paket</label>
                            <input type="number" name="harga_paket" class="form-control" value="{{ old('harga_paket') }}">
                            @error('harga_paket')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="file" name="foto_paket" class="form-control" value="{{ old('foto_paket') }}">
                            @error('foto_paket')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea rows="5" name="include_desc" class="form-control">{{ old('include_desc') }}</textarea>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Tidak Termasuk Paket (Exclude)</label>
                            <textarea rows="5" name="exclude_desc" class="form-control">{{ old('exclude_desc') }}</textarea>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Syarat dan Ketentuan (Term & Condition)</label>
                            <textarea rows="5" name="syaratketentuan" class="form-control">{{ old('syaratketentuan') }}</textarea>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Catatan Paket (Notes)</label>
                            <textarea rows="5" name="catatan" class="form-control">{{ old('catatan') }}</textarea>
                        </div>
                    </div>
                </div>
