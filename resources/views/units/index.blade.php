    ...
    <div class="page-body">
      <div class="container-xl">
        <div class="row row-cards">
          <div class="col-lg-4">
            <form class="card" method="POST" action="{{route('units.store')}}">
              @csrf
              ...
              <div class="card-body">
                <div class="mb-3">
                  ...
                  <input type="text" name="nama_unit" class="form-control" value="{{ old('nama_unit') }}">
                  @error('nama_unit')
                ...
                <div class="mb-3">
                  ...
                  <input type="text" name="satuan_unit" class="form-control" value="{{ old('satuan_unit') }}">
                  @error('satuan_unit')
                      <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                    ...
                    @forelse ($units as $m)
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                 <a href="{{route('units.edit',$m->id)}}" class="btn btn-sm btn-info"><i class="far fa-edit"></i></a>
