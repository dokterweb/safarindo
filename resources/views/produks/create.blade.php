    ...
    <div class="page-body">
      <div class="container-xl">
        <div class="row justify-content-center">
          <div class="col-8">
            <div class="card">
            <form action="{{ route('produks.store') }}" method="POST" enctype="multipart/form-data"  class="card">
                @csrf
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" name="standar_stok" class="form-control" value="{{ old('standar_stok') }}">
                            @error('standar_stok')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
