...
class StoreJamaahRequest extends FormRequest
{
    ...
    {
        return [
            'nik'           => 'required|digits:16',Rule::unique('jamaahs', 'nik')->ignore($this->route('id')),
            ...
            'no_pasport'            => 'nullable|string|max:255',Rule::unique('jamaahs', 'no_pasport')->ignore($this->route('id')),
